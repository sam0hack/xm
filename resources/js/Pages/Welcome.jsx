            ...
            <div className="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
                ...
                <div className="max-w-7xl mx-auto p-6 lg:p-8">
                    ...
                    <div className="container mx-auto p-10">
                        ...
                        <p className="mb-4">This application serves as a bridge between the user and valuable historical data concerning various companies. Users can effortlessly select a company, provide an email, and define a date range, which will then retrieve and display historical financial metrics for the selected company.</p>



                            <h2 className="text-3xl font-semibold mb-4">Accessing the Application</h2>
                            <p className="mb-4">To make the most out of the application's features, follow the steps below:</p>
                            <ol className="list-decimal list-inside mb-4">
                                <li className="mb-2">Register: Start by registering an account on the platform.</li>
                                <li className="mb-2">Login: After successful registration, log in using your credentials.</li>
                                <li className="mb-2">Dashboard Access: Upon logging in, you'll be automatically redirected to the dashboard. This central hub provides access to various functionalities.</li>
                                <li className="mb-2">Data Submission: From the dashboard, you can submit the form to view historical data specific to your inputs.</li>
